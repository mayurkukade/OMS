...
function Interview_Hr1({ AddInterview_Hr }) {

    const TABLE_HEAD22 = ["Profile", "Name", "Number", "Email", "Interview Scheduled On", "Assessment Status", "Status", "Action", ""];
    ...
    const TABLE_ROWS22 = [
        {
            ...
            number: "12345",
            email: "xyz@gmail.com",
            iScheduledOn: "12/12/23/11:30 am",
            aStatus: "Submitted",
            status: "onHold"
        },
        {
        ...
        <div>
            <div className="md:mr-44">
                <div className="md:mx-10 lg:mx-20 xl:mx-32">
                    <div className='flex md:flex-row mt-10 md:ml-0 ml-36 md:w-[25.6rem]'>
                    ...
                    <div className='flex flex-col md:flex-row bg-gray-600 w-full md:w-[50rem] h-auto md:h-10 mt-10 justify-center items-center'>
                        <div className="mr-48 md:mr-[20rem]">
                            <p className='text-xl'>Interview List</p>
                        </div>
                    ...
                    <div className='flex flex-col md:flex-row bg-gray-500 w-full md:w-[50rem] justify-center text-center items-center h-auto'>
                        <Button color="gray" className="mt-2 mb-2 md:mr-10 md:mb-0" onClick={AddInterview_Hr}>
                            Add Interview
                        </Button>

                        <div className="flex space-x-2 mt-2 md:mt-0">
                            <img src={pdf} alt="" className="w-8 mr-2" />
                            <img src={csv} alt="" className="w-8 mr-4" />
                            <img src={xls} alt="" className="w-8 mr-6" />
                        </div>

                        <div className="flex rounded-md mt-2 md:mt-0">
                            <input
                                type="text"
                        ...
                        <div className="w-full md:w-[10rem] mt-2 md:mt-0">
                    ...
                    <Card className="overflow-auto w-[25.6rem] md:w-[35rem] lg:w-[59rem]">
                        <CardBody className=" px-0">
                            <table className="w-full min-w-max table-auto text-left">
                                <thead>
                                    <tr>
                                        {TABLE_HEAD22.map((head) => (
                                            <th
                                                key={head}
                                ...
                                <tbody>
                                    {TABLE_ROWS22.map(
                                        (
                                            ...
                                            const isLast = index === TABLE_ROWS22.length - 1;
