...
function Homee() {
    ...
    const TABLE_HEAD2 = ["No.", "Task", "Assigned To", "Assigned Date", "End Date", "Status", ""];
    ...
    return (
        <div className='justify-center items-center md:mr-28'>
            <div className='flex flex-col md:flex-row'>
                <div className="md:ml-4">
                    ...
                    <div className="col bg-white border border-black m-1 md:w-[25rem] lg:w-[45rem] rounded-xl mt-2">
                        {/* First Section */}
                        <div className="md:flex items-center ml-2 mt-2">
                            <p className="text-lg md:text-xl lg:text-2xl">Complete 40 Screening Calls :</p>
                        ...
                        <div className="ml-2 mt-2">
                            <div className="flex">
                                ...
                                <textarea
                                    ...
                                    cols="10"
                                    rows="3"
                                    className="ml-5 mt-2 rounded-md border border-black w-full md:w-[35rem]"
                                >
                                    {/* Enter Description */}
                                </textarea>
                            </div>
                        ...
                        {/* Date Inputs */}
                        <div className="flex flex-col flex-wrap md:flex-row md:ml-2 m-2">
                            {/* Start Date */}
                            <div className="flex">
                                <p className="text-left text-lg mt-2">Start Date :</p>
                                <div className="w-full md:w-[18rem] lg:w-[35rem] ml-6">
                                    <Input size="lg" label="Start Date" type="date" placeholder="Enter your Start Date" name="startDate" />
                                </div>
                            </div>

                            {/* End Date */}
                            <div className="flex">
                                <p className="text-left text-lg mb-4 mt-5">End Date :</p>
                                <div className="w-full md:w-[18rem] lg:w-[35rem] ml-8 mt-3">
                                    <Input size="lg" label="End Date" type="date" placeholder="Enter your End Date" name="endDate" />
                                </div>
                            </div>

                            {/* Durations */}
                            <div className="flex">
                                <p className="text-left text-lg mb-4 mt-3">Durations :</p>
                                <div className="w-full md:w-[18rem] lg:w-[35rem] ml-6 mt-1">
                                    <Input size="lg" label="Durations" type="number" placeholder="Enter your Durations" name="durations" />
                                </div>
                            </div>

                            {/* Assigned To */}
                            <div className="flex">
                                <p className="text-left text-lg mb-4 mt-2">Assigned To :</p>
                                <div className="w-full md:w-[18rem] lg:w-[35rem] ml-1">
                                    <Input size="lg" label="Assigned To" type="text" placeholder="Enter Assigned To" name="assignedTo" />
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Second Section */}
                        <div className="md:flex items-center ml-2 mt-2">
                            <p className="text-lg md:text-xl lg:text-2xl">Complete 3 Interviews :</p>
                            <div className="ml-4 md:ml-9">
                                <div className="flex">
                                    <input
                                        type="radio"
            ...
            <div className='mr-4 md:mr-32 flex flex-col md:flex-row '>
            <div className='mb-4 md:mb-0'>
                <Card className="overflow-auto w-[25.6rem] md:w-[25rem] lg:w-[45rem] mt-4 md:ml-5">
