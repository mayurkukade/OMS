...
function AssessmentList1({ AddAssessment_Hr}) {

    const TABLE_HEAD51 = ["Profile", "Name", "Number", "Email", "Interview Scheduled On", "Assessment Status", "Status", "Result", "Action", ""];
            ...
            <div className="md:mr-44">
                <div className="md:mx-10 lg:mx-20 xl:mx-32">
                    ...
                    <div className='flex bg-gray-500 w-[50rem] justify-center text-center items-center h-auto'>
                        <Button color="gray" className="m-4" onClick={AddAssessment_Hr}>Add Participant</Button>
                    ...
                    <Card className="overflow-auto w-[25.6rem] md:w-[35rem] lg:w-[63.2rem]">
                        <CardBody className=" px-0">
                            <table className="w-full min-w-max table-auto text-left">
                                <thead>
                                    <tr>
                                        {TABLE_HEAD51.map((head) => (
                                            <th
                                                key={head}
                                ...
                                <tbody>
                                    {TABLE_ROWS51.map(
                                        (
                                            ...
                                            const isLast = index === TABLE_ROWS51.length - 1;
...
export default AssessmentList1
