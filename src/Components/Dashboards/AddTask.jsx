...
function AddTask() {
    return (
        <div className=" md:mx-10 lg:mx-20 xl:mx-32 justify-center">
            <div className='flex md:flex-row gap-4 m-4'>
                ...
                <div className='flex mr-[500px] md:ml-auto'>
            ...
            <div className='flex flex-col md:flex-row gap-10 md:ml-0 mt-6 m-4'>
                <div>
                    <p className='text-left text-lg mb-4'>
                        Task Name
                    </p>
                    <Input size="lg" label="Task" placeholder="Enter your task name" />
                </div>
                <div>
                    <p className='text-left text-lg mb-4'>
                        Due Date
                    </p>
                    <Input size="lg" type="date" label="Date" placeholder="Enter your date" />
                </div>
                <p className='text-left text-lg mb-4'>
                    Token Number :
            ...
            <div className='flex flex-col md:flex-row gap-10 md:ml-0 mt-6 m-4'>
                <div>
                    ...
                    <Input size="lg" label="Description" placeholder="Enter your Description" />
                </div>
                <div>
                    <p className='text-left text-lg mb-4'>
                        Assigned To
                    </p>
                    <Input size="lg" label="Assigned To" placeholder="Enter your Assigned To" />
                </div>
            </div>
            <div className='flex flex-col md:flex-row gap-10 md:ml-0 mt-6 m-4'>
                <div>
                    ...
                    <Input size="lg" label="Status" placeholder="Enter your Status" />
                </div>

            </div>
            <Button color="green" className="w-32 h-12 rounded-full m-4">Update</Button>
            <Button color="red" className="w-32 h-12 rounded-full mr-14">Cancel</Button>
        </div>
    )
}
