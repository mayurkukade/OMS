  ...
  return (
    // <div className='md:ml-'>
            <div className="md:mx-10 lg:mx-20 xl:mx-32 md:ml-[20rem]">
                <div className='flex md:flex-row flex-col mt-10 md:ml-0 ml-2 gap-2'>
                    ...
                    <div className='md:w-1/5'>
                        ...
                        <div className="flex gap-6 md:mt-4 mt-11">
                            <div className='flex gap-6 bg-[#adadad] w-36 h-20 rounded-2xl items-center justify-center'>
...
export default AddTask_TeamLead
