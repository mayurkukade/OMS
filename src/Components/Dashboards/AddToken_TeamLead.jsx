            ...
            <div className="md:mx-10 lg:mx-20 xl:mx-32 md:ml-[20rem]">
                <div className='flex md:flex-row mt-10 md:ml-0 ml-0 gap-2'>
                    <div className="md:w-1/6">
                        <p className='text-left text-lg mb-4 ml-2'>Running Projects</p>
                    ...
                    <div className='md:w-1/5 md:ml-32'>
                ...
                <div className='flex-col md:flex-row gap-10 md:ml-0 mt-6 m-4'>
                    ...
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" label="Task" placeholder="Enter your task name" name='taskName' value={formData.taskName} onChange={handleInputChange} />
                    </div>
                    <p className='text-left text-lg mb-4'>
                        Due Date :
                    </p>
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" type="date" label="Date" placeholder="Enter your date" name='dueDate' value={formData.dueDate} onChange={handleInputChange} />
                    </div>
                    <p className='text-left text-lg mb-4'>
                        Description :
                    </p>
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" label="Description" placeholder="Enter your Description" name='description' value={formData.description} onChange={handleInputChange} />
                    </div>
                    ...
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" label="Assigned To" placeholder="Enter your Assigned To" name='assignedTo' value={formData.assignedTo} onChange={handleInputChange} />
                    </div>
                    <p className='text-left text-lg mb-4'>
                        Status :
                    </p>
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" label="Status" placeholder="Enter your Status" name='status' value={formData.status} onChange={handleInputChange} />
                    </div>
                    <p className='text-left text-lg mb-4'>
                        Assigned By :
                    </p>
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" label="Assigned By" placeholder="Enter your Assigned By" name='assignedBy' value={formData.assignedBy} onChange={handleInputChange} />
                    </div>
                    <p className='text-left text-lg mb-4'>
                        Task Id :
                    </p>
                    <div className="w-full md:w-[18rem] lg:w-[35rem]">
                        <Input size="lg" label="Task Id" placeholder="Enter your Task Id" name='taskId' value={formData.taskId} onChange={handleInputChange} />
                    </div>
                    <div className="mt-4 space-x-4 md:ml-0 ml-14">
                        <Button color="green" className="w-32 h-12 rounded-full " onClick={handleUpdate}>Update</Button>
...
export default AddToken_TeamLead;