...
function CompletedTask_TeamLead() {

    const TABLE_HEAD = ["Task", "Assign To", "Due Date", "Description", "Status", "Action", ""];

    const TABLE_ROWS = [
        {
            taskName: "FE Development",
            assignTo: "XYZ",
            dueDate: "1/12/23",
            description: "UI/UX",
            status: "Completed",
    ...
    const TABLE_HEAD2 = ["Task", "Assign To", "Time", "Description", "Status", "Action", ""];
    ...
    const TABLE_HEAD3 = ["Task", "Assign To", "No of Tasks", "Completed", "InComplete", "Time", ""];
    ...
    const generateExcelFile = () => {
        // Create Excel file content using xlsx library
    ...
    return (
        <div className="md:ml-">
            <div className="md:mx-10 lg:mx-20 xl:mx-32">
                ...
                <div className='flex bg-gray-600 w-[50rem] rounded-md h-10 mt-10 justify-center items-center'>
                    <div className="mr-48 md:mr-[20rem]">
                        <p className='text-xl'>Running Task Duration</p>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" className='mt-[0.1rem] ml-64' width="10" height="12" viewBox="0 0 10 14" fill="none">
                ...
                <div className='flex bg-gray-500 w-[50rem] rounded-md justify-center text-center items-center h-20'>
                    <p className='text-3xl'>05:00:00 Hrs</p>
                </div>
                <div className='flex bg-gray-600 w-[50rem] rounded-md h-10 mt-10 justify-center items-center'>
                    <div className="mr-64 md:mr-[23rem]">
                ...
                <div className='flex bg-gray-500 w-[50rem] rounded-md justify-center text-center items-center h-auto'>
                ...
                <Card className="md:w-[25rem] lg:w-[50.2rem]  w-[25.6rem] overflow-auto">
                ...
                {/* Completed Task BDE Development HR */}

                <div className="mt-6 flex gap-10">
                    <select
                        className="mt-1 block mb-28 p-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
                ...
                <Card className="overflow-auto md:w-[25rem] lg:w-[51.2rem]  w-[25.6rem]">
                    <CardBody className=" px-0">
                        <table className="w-full min-w-max table-auto text-left">
                            <thead>
                                <tr>
                ...
                <Card className="overflow-auto md:w-[25rem] lg:w-[51.2rem] w-[25.6rem] mt-10">
                    <CardBody className=" px-0">
                        <table className="w-full min-w-max table-auto text-left">
                            <thead>
                                <tr>
                                                ...
                                                <td className={classes}>
                                                    <div className="flex items-center gap-3">
                                                        <Typography
                                                            variant="small"
                                                            color="blue-gray"
                                                            className="font-normal text-center justify-center items-center"
                                                        >
                                                            {taskName}
                                                        </Typography>
                                                    </div>
...
export default CompletedTask_TeamLead
