                            ...
                            <div className="flex items-center ml-2 mt-2">
                                ...
                                <div className='ml-4 md:ml-9'>
                                    <div className='flex'>
                                        ...
                                        />
                                        <label htmlFor="done" className="ml-2 text-gray-700">Done</label>
                                        <input
                                            type="radio"
                                            id="pause"
                                            name="status"
                                        ...
                                        />
                                        <label htmlFor="pause" className="ml-2 text-gray-700">Pause</label>
                                        <input
                                            type="radio"
                                            id="pending"
                                            name="status"
                                        ...
                                        />
                                        <label htmlFor="pending" className="ml-2 text-gray-700">Pending</label>
                                        <input
                                            type="radio"
                                            id="close"
                                            name="status"
                                        ...
                                        />
                                        <label htmlFor="close" className="ml-2 text-gray-700">Close</label>
                                    </div>
                                </div>
                            </div>
                            <div className='ml-2 mt-2'>
                                <div className='flex'>
                                    <p className='mt-8 text-lg'>Desciption :</p>
                                    <textarea name="tArea" id="tArea" cols="10" rows="3" className='ml-5 mt-2 rounded-md border border-black w-[35rem]'>
                                        {/* Enter Description */}
                                    </textarea>
                                </div>
                            </div>
                            <div className='flex flex-col flex-wrap md:flex-row md:ml-2 m-2'>
                                ...
                                <div className='flex'>
                                    ...
                                    <div className="w-full md:w-[18rem] lg:w-[35rem] ml-1">
                                        <Input size="lg" label="Assigned By" type='text' placeholder="Enter Assigned By" name='assignedBy' />
                                    </div>
                                </div>
                            </div>
                        </div>
