...
function AttendenceReport() {
    ...
    return (
        ...
        <div className="  xl:mx-20">
            <div className='flex md:flex-row mt-10 md:ml-0 ml-2 '>
            ...
            <div className='flex bg-gray-600 w-[rem] h-10 mt-10 justify-center items-center'>
            <div className='mr-80 md:mr-[37rem]'>
                <p className="text-xl">Attendence Report</p>
                </div>
            ...
            <div className='bg-gray-500 '>
                <div className='flex space-x-4'>
                    <div className='md:ml- mt-6 flex '>
                        <p className='mt-3 m-4 font-bold'>Department</p>
                        <select
                            className="mt-1 block mb-4 md:mb-28 p-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
                        ...
                        {selectedOption && <p className="mt-2 ml-2">Selected option: {selectedOption}</p>}
                        <p className='mt-3 m-4 font-bold'>Months</p>
                        <select
                            className="mt-1 block mb-4 md:mb-28 p-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500"
                        ...
                        {selectedOption && <p className="mt-2 ml-2">Selected option: {selectedOption2}</p>}
                    </div>
                </div>
            </div>
