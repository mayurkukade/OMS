    ...
    return (
        <div className=''>
            <div className="md:mx-10 lg:mx-20 xl:mx-32">
                ...
                <div className='flex bg-gray-600 w-full md:w-[50rem] h-auto mt-10 justify-center items-center'>
                    <div className='mr-80 md:mr-[37rem]'>
                        <p className="text-xl md:ml-0 mr-4">Project Report</p>
                    </div>
                ...
                <div className="bg-gray-500 w-full md:w-[50rem] justify-center text-center items-center h-auto">
                    <div className="flex flex-col md:flex-row space-y-4 md:space-y-0">
                        <div className="md:ml-20 mt-6 flex">
                            <div className="mt-3 m-4 font-bold">
                                <p>Project Assignment</p>
                                <div className="w-full md:w-72 font-normal">
                                    <textarea
                                        name="tArea"
                                        id="tArea"
                                        cols="10"
                                        rows="3"
                                        className="ml-5 mt-2 text-black rounded-md border border-black w-full md:w-[15rem]"
                                    >
                                        API Integration
                                    </textarea>
                                </div>
